    ...
    <nav class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#">Cotizaciones</a></li>
                 ...
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="proveedor_registrar.php">Agregar un nuevo proveedor</a></li>
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">Producto<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="refacciones_seleccionar_marca.php">Agregar producto</a></li>
                        <li class="divider"></li>
